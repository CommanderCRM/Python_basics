...
if __name__ == '__main__':
    ...
    print("Студент: {0} {1} / номер студенческого билета: {2}".format(student1.getName(),student1.getSurname(),student1.getNumber().getNumber()))
    print("Студент: {0} {1} / номер студенческого билета: {2}".format(student2.getName(),student2.getSurname(),student2.getNumber().getNumber()))
    print()
    ...
    print('{} изучает дисциплины: {}'.format(student1.getFullName(),'; '.join(student1.getStuff())))
    print()
    ...
    print("Студент: {0} {1} из группы № {2}".format(student1.getName(),student1.getSurname(),student1.getGroup().getTitle()))
    print("Студент: {0} {1} из группы № {2}".format(student2.getName(),student2.getSurname(),student2.getGroup().getTitle()))
    print()
    ...
    print("Студент {0} имеет средний балл {1}".format(student1.getFullName(),student1.getMarks()))
    print()
